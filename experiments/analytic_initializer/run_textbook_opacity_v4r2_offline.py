"""Run the preregistered v4r2 domain-raise offline validation."""
...
TEMPERATURE_FLOOR_K = V4R2_FORMAL_TEMPERATURE_FLOOR_K
V4R1_OFFLINE = Path(
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        default=Path(
            ...
            "textbook_opacity_v4r2_offline_validation_20260827.json"
        ),
    )
    ...
    if TEMPERATURE_FLOOR_K <= PREVIOUS_FLOOR_K:
        raise SystemExit("v4r2 floor must be strictly above the v4r1 floor")
    for required in (args.v4r1_offline, args.molecule_ablation):
    ...
    result = {
        "schema_version": 1,
        "candidate": (
            "agss09_ground_partition_saha_john_hminus_freefree_v4r1_domain_4000K"
        ),
        "version": "v4r2",
        "status": status,
        "decision": decision,
        ...
        "v4r2_change": {
            "opacity_construction": "unchanged v4r1",
            ...
            "declared_domain_change_not_hidden_molecular_correction": True,
        },
